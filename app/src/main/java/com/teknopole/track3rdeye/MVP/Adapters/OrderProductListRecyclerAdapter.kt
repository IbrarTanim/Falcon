 ...
 */
class OrderProductListRecyclerAdapter(private var productList: List<OrderProductDetail>, private val listener: EventListener) : RecyclerView.Adapter<OrderProductListRecyclerAdapter.ViewHolder>() {
